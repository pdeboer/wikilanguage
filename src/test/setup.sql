...
--
-- Host: localhost    Database: wikilanguage
-- ------------------------------------------------------
...
CREATE TABLE `categories` (
  ...
  `wiki_language` char(2) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `people2categories`
--
...
--
-- Dumping data for table `people2categories`
--

LOCK TABLES `people2categories` WRITE;
/*!40000 ALTER TABLE `people2categories` DISABLE KEYS */;
/*!40000 ALTER TABLE `people2categories` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2013-10-12 22:42:06
